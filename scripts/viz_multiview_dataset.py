...
def main(args):
    if args.dataset == "dexycb":
        ...
        cfg = CN(INTERHAND_MV_CONFIG)
        dataset = InterHandMultiView(cfg)
    elif args.dataset == "arctic":
        cfg = CN(ARCTIC_MV_CONFIG)
        dataset = ArcticMultiView(cfg)
    else:
